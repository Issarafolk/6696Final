...
<head>
    ...
    <style>
        ...
        .page-container {
            ...
            padding: 30px;
            border: 2px solid #0077c0; /* Blue border */
        }

        h1 {
            color: #00b8ff; /* Bright blue */
            font-weight: 800;
            margin-bottom: 30px;
            border-bottom: 3px solid #0077c0; /* Blue */
            padding-bottom: 15px;
            text-align: center;
            text-transform: uppercase;
            letter-spacing: 2px;
            font-size: 2.8rem; /* Increased font size */
            text-shadow: 0 0 10px #00b8ff, 0 0 20px #00b8ff, 0 0 30px #00b8ff; /* Blue glowing effect */
        ...
        @keyframes blueGlow {
            ...
            to {
                text-shadow: 0 0 15px #00b8ff, 0 0 25px #00b8ff, 0 0 35px #00b8ff, 0 0 45px #00b8ff;
            }
        }
        ...
        .btn-primary:hover {
            background-color: #00b8ff; /* Bright blue */
            border-color: #0077c0;
        ...
        .user-info-box {
            ...
            padding: 12px 20px;
            margin: 20px 0;
            box-shadow: 0 4px 8px rgba(0, 119, 192, 0.2);
        }
    ...
    <title>แก้ไขข้อมูลนักฟุตบอล</title>
</head>
    ...
    <div class="container page-container">
        <div class="user-info-container">
            ...
            <div class="user-info-box">
                ...
                <div class="user-info-data">ระบบจัดการข้อมูลนักฟุตบอล 7 ฟุต</div>
            </div>
        </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                        <select name="ประเภท_ฟุตบอล" class="form-select" required>
                            ...
                            <option value="ฟุตบอลกระชับมิตร" <?php if ($row['ประเภท_ฟุตบอล']=='ฟุตบอลกระชับมิตร'){ echo "selected";} ?>>ฟุตบอลกระชับมิตร</option>
                        </select>
                    </div>
                </div>
        ...
        <div class="footer mt-4">
            ระบบจัดการข้อมูลนักฟุตบอล 7 ฟุต
        </div>
    </div>
